...
* **💾 Автосохранение состояния:** Программа автоматически запоминает позицию на экране, значение счетчика, выбранный язык, режим блокировки и другие настройки.
* **📥 Работа в системном трее:** Виджет можно свернуть в трей, при этом подсчет нажатий продолжается в фоновом режиме.
...
* **Выход** — сохранение настроек и закрытие приложения.
